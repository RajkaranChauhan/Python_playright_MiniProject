...
test
 ...
 #1. keeping the conftest.py file outsid of steps and in all dir throws error.
it should be kept under steps folder along with steps file where it is being used.
